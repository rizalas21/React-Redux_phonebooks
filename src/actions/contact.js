...
export const UpdateAvatar = (id, avatar) => dispatch => req.put(`phonebooks/${id}/avatar`, avatar).then(({ data }) => [
    dispatch({ type: 'UPDATE_AVATAR_SUCCESS', photo: data })
]).catch((err) => {
